  ...
  return (
    <main className="min-h-screen px-4 py-4 lg:px-6 lg:py-6">
      <div className="mx-auto max-w-[1860px]">
        <div className="mb-4 rounded-[28px] border border-white/10 bg-black/20 px-5 py-4"><p className="font-display text-xs uppercase tracking-[0.28em] text-slate-400">Catapult 2026</p><h1 className="mt-2 font-display text-4xl font-semibold text-white">Automation-style build configurator</h1><p className="mt-2 max-w-4xl text-sm leading-6 text-slate-300">Engine family, editable engine spec, drivetrain tuning, deterministic validation, proxy 3D, live dyno, and vehicle metrics all come from the active BuildState.</p></div>
